...
class CowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cow" do
    assert_difference('Cow.count') do
      post cows_url, params: { cow: { birth: @cow.birth, milk: @cow.milk, name: @cow.name, weight: @cow.weight } }
    end
  ...
  test "should update cow" do
    patch cow_url(@cow), params: { cow: { birth: @cow.birth, milk: @cow.milk, name: @cow.name, weight: @cow.weight } }
